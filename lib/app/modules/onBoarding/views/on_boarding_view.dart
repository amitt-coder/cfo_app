            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return Stack(
                children: [
                  Column(
                    children: [
                      SizedBox(height: index==0? MediaQuery.of(context).size.height*0.07:MediaQuery.of(context).size.height*0.05,),
                      Container(
                        height:index==0? MediaQuery.of(context).size.height*0.55:MediaQuery.of(context).size.height*0.57,
                        alignment: Alignment.center,
                        color: AppColor.whiteColor,
                        child: SvgPicture.asset(page['images']!,fit: BoxFit.fill,),
                      ),
                      Container(
          ...
          Positioned(
            ...
            child:  InkWell(
              ...
              child: Container(
                  ...
                  child: Icon(Icons.arrow_forward,size: 24,color: Color(0xFF1061FF),)
              ),
            ),),
        ],
      ),
