...
class _FinancialProjectionViewState extends State<FinancialProjectionView> {
  ...
  FinancialProjectionController financialProjectionController = Get.put(FinancialProjectionController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Container(
        ...
        child:
        financialProjectionController.thirdCheck.value==false?
        Column(
          children: [
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          size: 25,color: AppColor.txtSecondaryColor,
                          )
                        ],
                      ),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Icon(Icons.more_vert,
                        size: 20,color: AppColor.txtSecondaryColor,
                      )
             ...
             Row(
               ...
               children: [
                 ...
                 CommonTextField(
                   ...
                   width: 100,
                   lableText: '',
                   controllers: financialProjectionController.discountRate,
             ...
             Column(
               ...
               children: [
                 ...
                 CommonTextField(
                   ...
                   width: 100,
                   lableText: '',
                   controllers: financialProjectionController.growthRate,
                   keyboardTypes: TextInputType.name,
                   prefixIcon: ProjectImages.mail,
                 ),
               ],
             ...
             Container(
               ...
               child: Stack(
                 children: [
                   ...
                   CustomPaint(
                     painter: DottedLinePainter(Offset(120, 120), Offset(100, 80)),
                     child: Container(),
                   ),
                   Positioned(
                     top: 40,
                     left: 0,
                     child: buildIndicator('Revenue Projection', 20, Colors.blue),
                   ),
                   CustomPaint(
                     painter: DottedLinePainter(Offset(180, 290), Offset(180, 350)),
                     child: Container(),
                   ),
                   Positioned(
                     bottom: 20,
                     left: 100,
                     child: buildIndicator('Cost Projection', 60, Colors.green),
                   ),
                   CustomPaint(
                     painter: DottedLinePainter(Offset(230, 130), Offset(290, 100)),
                     child: Container(),
                   ),
                   Positioned(
                     top: 60,
                     right: 0,
                     child: buildIndicator('Asset Depreciation', 20, Colors.red),
                   ),
                 ],
               ),
             ),
