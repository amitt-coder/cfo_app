...
class VarianceTabsView extends StatefulWidget {
  String whichUser = '';
  VarianceTabsView({this.whichUser = ''});

  @override
  State<VarianceTabsView> createState() => _VarianceTabsViewState();
}

class _VarianceTabsViewState extends State<VarianceTabsView> {
  VarianceTabsController varianceTabsController =
  Get.put(VarianceTabsController());
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: TabBarView(
                  controller: varianceTabsController.tabController,
                  children: varianceTabsController.listingScreens,
                ),
              ),
            ],
          ),
